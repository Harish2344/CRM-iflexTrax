...
<div class="card">
    ...
    <div class="info-section">
        ...
        <div class="form-group">
            ...
            <input type="email" id="email_id" name="email_id" placeholder="Enter your email_id" required>
            
        </div>
        <div class="form-group">
            <label for="phone">Phone</label>
            <input type="number" id="phone" name="phone" placeholder="Enter your phone_No" required>
    ...
    <div class="address-section">
        ...
        <div class="address-item">
            ...
            <input type="text" id="addressLine1" name="addressLine1" placeholder="Enter addressLine1" required>
            
        </div>
        <div class="address-item">
            <label for="addressLine2">Address Line 2</label>
            <input type="text" id="addressLine2" name="addressLine2" placeholder="Enter addressLine2" required>
